...
public class LogSinglePlantLengthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_log_single_plant_length);
        ...
        graphView.setTitle("Shoot length via weeks");

        GridLabelRenderer gridLabel=graphView.getGridLabelRenderer();
        gridLabel.setHorizontalAxisTitle("weeks");
        gridLabel.setVerticalAxisTitle("Shoot length(cm)");
        ...
        current_plant.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    if(snap.child("length").exists()) {
                        String y = snap.child("length").getValue() + "";
                        Log.i("=======length ",y);
